...
plt.plot(alpha1[0:14],0.5*(CM1[0:14]+CM2[0:14]),color=[1,0,0])
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:14],0.5*(CM1[0:14]+CM2[0:14]),color=[1,0.65,0])
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:15],0.5*(CM1[0:15]+CM2[0:15]),'g')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:15],0.5*(CM1[0:15]+CM2[0:15]),'c')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:15],0.5*(CM1[0:15]+CM2[0:15]),'b')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:15],0.5*(CM1[0:15]+CM2[0:15]),'k--')

plt.legend(('+0.182c, +0.222D','+0.091c, +0.111D','0, 0','-0.091c, -0.111D','-0.182c, -0.222D','No Propeller'),fontsize=fsize,loc='lower left')
plt.ylim((-1.8,0.2))
plt.xlim((0,30))
plt.title('Clean Wing',fontsize=fsize)
plt.xlabel('Angle of Attack (deg)',fontsize=fsize)
plt.ylabel('Pitching Moment Coefficient',fontsize=fsize)
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:11],0.5*(CM1[0:11]+CM2[0:11]),color=[1,0,0])
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:10],0.5*(CM1[0:10]+CM2[0:10]),color=[1,0.65,0])
...
plt.plot(alpha3[0:10],0.5*(CM2[0:10]+CM3[0:10]),'g')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:11],0.5*(CM1[0:11]+CM2[0:11]),'c')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:12],0.5*(CM1[0:12]+CM2[0:12]),'b')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha2[0:9],0.5*(CM1[0:9]+CM2[0:9]),'k--')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:10],0.5*(CM1[0:10]+CM2[0:10]),color=[1,0,0])
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:11],0.5*(CM1[0:11]+CM2[0:11]),'g')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:11],0.5*(CM1[0:11]+CM2[0:11]),'b')
...
[alpha2, CL2, CD2, CM2] = process(p_dyn1, Sref1, data2, calib2, prop1)
plt.plot(alpha1[0:7],0.5*(CM1[0:7]+CM2[0:7]),'k--')
